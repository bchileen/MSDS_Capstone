...
build_lstm_model_improved <- function(sequence_length, n_features, forecast_horizon) {
...
cat("\n")
cat("╔════════════════════════════════════════════════════════════════════════╗\n")
cat("║                 LSTM FORECAST HORIZON ANALYSIS                         ║\n")
cat("╚════════════════════════════════════════════════════════════════════════╝\n\n")
...
create_forecast_confidence_plot <- function(lstm_result, dataset_name) {
  ...
  p_confidence <- ggplot(horizon_stats, aes(x = Horizon)) +
    ...
    labs(
      ...
      subtitle = "Blue band = 95% CI, Red lines = ±1 RMSE",
...
cat("\n")
cat("╔════════════════════════════════════════════════════════════════════════╗\n")
cat("║              LSTM HORIZON SUMMARY (FOR PAPER)                          ║\n")
cat("╚════════════════════════════════════════════════════════════════════════╝\n\n")
